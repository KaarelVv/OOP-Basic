...
school.addStudent(student1)
console.log("---------------------------------------------")
console.log("Amount of student in school :" + school.getStudents().length)  // 2
console.log("---------------------------------------------")
...
console.log("---------------------------------------------")
console.log("School name :" + school.getName())
console.log("---------------------------------------------")
//we cannot add one course twice
school.addCourse(course1)
console.log("---------------------------------------------")
console.log("Amount of courses :" + school.getCourses().length) // 2
console.log("---------------------------------------------")
...
school.addStudentGrade(student2, course1, 3)
school.addStudentGrade(student2, course1, 3)
console.log("---------------------------------------------")
console.log(student1)
console.log("Avg grade  :" + student1.getAverageGrade())
